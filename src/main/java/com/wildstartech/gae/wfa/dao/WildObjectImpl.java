...
/**
 * This object provides the base foundation for all entites that are stored in a
 * persistent data store using the Wildstar Foundation Architecture Data Access
 * Object (DAO) design pattern. This specific implementation of the
 * 
 * {@code WildObject} interface is intended for use with the DataStore framework
 *        made available through the Google App Engine platform.
 * 
 *        <p>
 *        Each {@code Entity} in the Datastore should be represented by a
 *        concrete subclass of the this class. Subclasses should provide an
 *        implementation of the {@code getKind()} method which the
 * {@code WildDAOImpl} class will use to manage reading and writing information
 *        out to Google's Datastore.
 *        </p>
 * 
 *        <p>
 *        In addition, a concrete sub-class of this class should over-ride the
 ...
 *        </ul>
 *        <p>
 *        When a sub-class overrides these methods, the first line in their code
 *        should be an invocation of the super class' version of the same
 *        method. For example:
 *        </p>
 *        <blockquote>
 * {@code public void populateEntity(Entity entity) {
 *        super.populateEntity(entity); ... } } </blockquote>
 *        <p>
 *        or
 *        </p>
 *        <blockquote>
 * {@code public void populateFromEntity(Entity entity) {
 *        super.populateFromEntity(entity); ... } } </blockquote>
 *        <p>
 *        In doing this, each class is only responsible for managing data that
 *        it is aware of. Inherited fields are managed by the super class.
 *        </p>
 * 
 * @author Derek Berube, Wildstar Technologies, LLC.
 * @version 0.1, 2013.08.17
 */
public abstract class WildObjectImpl<T> implements Serializable, WildObject {
   ...
   /*
    * Name of the user who originally stored the object in the persistent data
    * store.
    */
   private String createdBy = "";
   /*
    * Name of the user who last saved the object in the persistent data store.
    */
    ...
    * 
    * @param resourceId Identifies the specific message in the resource 
    * bundle that should be returned.
    * 
   ...
   public String getLocalizedMessage(String resourceId, Object[] params) {
      logger.entering(_CLASS, "getMessage(String,Object[])", 
    ...
    * 
    * <p>
    * The value returned will be false unless it is equal to the word "true"
    * (case-insensitive without the quotes).
    * </p>
    * 
    ...
    * event the entity DOES NOT contain the specified property or the 
    * specified property cannot be parsed as a {@code boolean} value.
    * @return The value stored in the identified property represented by a
    * {@code boolean} primitive.
    */
   ...
   /**
    * The specified property is recorded in the data store as a 
    * {@code String} formatted using the specified {@code DateFormat};
    * however, the goal is to have the value returned as a {@code Date}.
    * 
    * @param entity
    *           The {@code Entity} object that contains the data which we are
    *           searching through.
    * @param propName
    *           The name of the property whose value should be returned as
    *           a {@code Date}
    * @param format
    *           The $
    * @return
    ...
    *           a {@code Date}
    * @param defaultDate
    *           The {@code Date} value to be returned in the event the entity
    *           DOES NOT contain the specified property or the specified
    ...
    * 
    * <p>
    * If the property is null or contains an unparseable double, this method
    * will return the value of {@code Double.MIN_VALUE}.
    * </p>
    * 
    * @param entity  The {@code Entity} object that contains the data which
    * we are searching through.
    * @param propName The name of the property whose value we want to return
    * as a {@code double}
    ...
    * </p>
    * 
    * @param entity The {@code Entity} object that contains the data which we
    * are searching through.
    * @param propName The name of the property whose value we want to return
    * as a {@code double}
    * @param defaultValue The {@code double} value to be returned in the 
    * event the entity DOES NOT contain the specified property or the 
    * specified property cannot be parsed as a double value.
    * @return The value stored in the identified property as represented by a
    * {@code double}.
    */
   protected double getPropertyAsDouble(
         Entity entity, String propName, double defaultValue) {
    ...
    * 
    * <p>
    * If the property is null or contains an unparseable float, this method
    * will return the value of {@code Float.MIN_VALUE}.
    * </p>
    * 
    * @param entity The {@code Entity} object that contains the data which
    * we are searching through.
    * @param propName The name of the property whose value we want to 
    * return as an {@code float}
    * @return The value stored in the identified property as represented 
    * by a {@code float}.
    */
    ...
    * event the entity DOES NOT contain the specified property or the
    * specified property cannot be parsed as a float value.
    * @return The value stored in the identified property as represented 
    * by a {@code float}.
    */
    ...
    * <p>
    * If the property is null or contains an unparseable integer, this method
    * will return the value of {@code Integer.MIN_VALUE}.
    * </p>
    */
    ...
    * we are searching through.
    * @param propName The name of the property whose value we want to 
    * return as an {@code int}
    * @param defaultValue The {@code int} value to be returned in the event
    * the entity DOES NOT contain the specified property or the specified
    * property cannot be parsed as a integer value.
    * @return The value stored in the identified property as represented by 
    * an {@code int}.
    */
         ...
         if (obj instanceof String) {
            ...
            if (validator.isValid(tmpStr)) {
               try {
                  ...
                  logger.log(Level.WARNING, "This should not happen.", ex);
               } // END try/catch
            } else {
               msgFmt = new MessageFormat(MSG_INVALID_DATATYPE);
               msg = msgFmt.format(
                     new Object[] { obj, propName, "InetAddress" });
               logger.finest(msg);
    ...
    * 
    * <p>If the property is null or contains an unparseable long, this method 
    * will return the value of {@code Long.MIN_VALUE}.</p>
    * 
    * @param entity The {@code Entity} object that contains the data which we
    * are searching through.
    * @param propName The name of the property whose value we want to return
    ...
    * we are searching through.
    * @param propName The name of the property whose value we want to 
    * return as an {@code long}
    * @param defaultValue The {@code long} value to be returned in the 
    * event the entity DOES NOT contain the specified property or the 
    * specified property cannot be parsed as a long value.
    * @return The value stored in the identified property as represented 
    * by a {@code long}.
    */
    ...
    * event the entity DOES NOT contain the specified property or the 
    * specified property cannot be parsed as a short value.
    * @return The value stored in the identified property as represented by a
    * {@code long}.
    */
    ...
    * 
    * <p>If the property is null, this method will return an empty
    * {@code String}.</p>
    * 
   ...
   protected String getPropertyAsString(Entity entity, String propName) {
      logger.entering(_CLASS, "getPropertyAsString(Entity,String)", 
            new Object[] { entity, propName });
      String value = "";
      value=getPropertyAsString(entity,propName,"");
      logger.exiting(_CLASS, "getPropertyAsString(Entity,String)", value);
      return value;
   }

   /**
    * Returns the value of the specified property as a {@code String} and 
    * if the {@code Entity} does not contain the specified property return
    * the default value specified.
    * 
    * <p>If the {@code property} is null and the specified 
    * {@code defaultValue} is null, this method will return an empty 
    * {@code String}.</p>
    *
    * @param entity The {@code Entity} object that contains the data 
    * which we are searching through.
    * @param propName The name of the property whose value we want to 
    * return as a String
    * @param defaultValue The {@code String} to be returned in the event 
    * the {@code entity} DOES NOT contain the specified {@code property}.
    * @return The value stored in the identified property as represented
    * by a {@code String}.
    */
   protected String getPropertyAsString(
         Entity entity, 
         String propName, 
         String defaultValue) {
      logger.entering(_CLASS, "getPropertyAsString(Entity,String,String)", 
            new Object[] {entity,propName,defaultValue});
      Object obj = null;
      String value = null;
      Text text = null;
      obj = getProperty(entity, propName);
      if (obj != null) {
         // The entity contains a property with the specified name.
         if (obj instanceof String) {
            value = (String) obj;
      ...
      logger.exiting(_CLASS, "getPropertyAsString(Entity,String,String)", value);
      return value;
   }

   /**
    * Returns the {@code baseName} for the {@code ResourceBundle} that should be
    * used when localizing messages.
    * 
    * @return A string value that will be used by the
    *         {@code getLocalizedMessage} method to return the requested
    *         loalized resource.
    */
   @Override
   public String getResourceBundleBaseName() {
      logger.entering(_CLASS, "getResourceBundleBaseName()");
      logger.exiting(_CLASS, "getResourceBundleBaseName()", WildObject.RESOURCE_BUNDLE);
    ...
    * 
    * <p>
    * The default implementation of this method will not actually populate any
    * information in the specified entity object as the main properties
    * contained in this object are properties that are immutable such as {@code
    * dateCreated} and {@code createdBy} or properties that are going to be
    * updated by the {@code DAO} such as
    * 
    * {@code dateModified} and {@code modifiedBy}.
    *        </p>
    * 
    * @param entity
    *           The instance of the {@code Entity} class from the
   ...
   public String toPropertyString() {
      ...
      sb.append("dateCreated=\"").append(getFormattedDate(
            getDateCreated())).append("\", ");
      sb.append("modifiedBy=\"").append(getModifiedBy()).append("\", ");
      sb.append("dateModified=\"").append(getFormattedDate(
            getDateModified()));
