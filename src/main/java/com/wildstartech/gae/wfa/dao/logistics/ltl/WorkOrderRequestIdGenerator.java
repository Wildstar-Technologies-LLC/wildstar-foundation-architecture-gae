/*
 * Copyright (c) 2015 - 2016 Wildstar Technologies, LLC.
 *
...
public class WorkOrderRequestIdGenerator
      extends TicketingShardedCounter<WorkOrder> {
   private static final String _CLASS=
         WorkOrderRequestIdGenerator.class.getName();
   ...
   protected String getPrefix() {
      ...
      logger.exiting(_CLASS, "getPrefix()","WRK");
      return "WRK";
   }
}